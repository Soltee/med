        	...
        	<form action="{{ route('admin.products.store')}}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
	            ...
	            class="flex items-center justify-between mb-3">
	            	<div class="flex items-center">
			            ...
			            <h2 class="text-xl font-semibold leading-tight my-3 text-gray-800">Product</h2>
			        </div>
		        ...
		        <div class="w-full flex flex-col">
		        	...
		        	<div class="flex flex-col mb-4">
		        		...
		        		<input type="text" id="name" name="name" class="px-3 py-3 rounded border-2 text-gray-700 border-transparent border-2 border-green-300 hover:border-green-600 @error('name') 'border-red-600' @enderror" value="{{ old('name') }}">
					...
					<div class="flex flex-col sm:flex-row mb-4">
						<div class="flex-1 sm:mr-3 flex flex-col">
			        		...
			        		<input type="text" id="price" name="prev_price" class="px-3 py-3 rounded border-2 text-gray-700 border-transparent border-2 border-green-300 hover:border-green-600 @error('prev_price') 'border-red-600' @enderror" value="{{ old('prev_price') }}">
						...
						<div class="flex-1 sm:ml-3 flex flex-col">
			        		...
			        		<input type="text" id="price" name="price" class="px-3 py-3 rounded border-2 text-gray-700 border-transparent border-2 border-green-300 hover:border-green-600 @error('price') 'border-red-600' @enderror" value="{{ old('price') }}">
		        	...
		        	<div class="flex flex-col mb-4">
		        		...
		        		<input type="text" id="quantity" name="quantity" class="px-3 py-3 rounded border-2 text-gray-700 border-transparent border-2 border-green-300 hover:border-green-600 @error('quantity') 'border-red-600' @enderror" value="{{ old('quantity') }}">
